...
def run(img_fn):
    ...
    dmap_fn = os.path.join(os.path.dirname(gt_fn), basename + '_dmap.npy')
    ...
    print(f"Processed {img_fn} -> {dmap_fn}")


if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--path', type=str, default='data/jhu_crowdpp',
                        help='Processed dataset root containing train/val/test directories.')
    parser.add_argument('--workers', type=int, default=8,
                        help='Number of density-map generation workers.')
